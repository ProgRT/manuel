...
%Ce que l'on désigne habituellement comme le ventilateur VDR-4 est en fait composé d'un ensemle de composantes au fonctionnement relativement indépendant.
%
%Le module de contrôle -désigné VDR-4 par le manufacturier- et le phasitron sont les deux composantes strictement essentiel. Le module de monitorage et le système
%
